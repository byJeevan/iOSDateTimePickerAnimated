...
@objc public class DateTimePicker: UIView {
    ...
    public var highlightColor = UIColor(red: 195.0/255.0, green: 181.0/255.0, blue: 223.0/255.0, alpha: 1) {
        didSet {
    ...
    internal var contentBgView : UIImageView!
    internal var contentSunMoonView:UIImageView!
    ...
    private func setContentImageView() {
        
        self.contentBgView = UIImageView.init(frame:self.contentView.bounds)
        self.contentBgView.image = UIImage.init(named: "flat_day.png")
        self.contentBgView.contentMode = .scaleAspectFill
        self.contentView.addSubview(self.contentBgView)
      
        let widthConstant = 150
        self.contentSunMoonView = UIImageView.init(frame:CGRect.init(x: -5, y: Int(self.contentBgView.center.y - 50), width: widthConstant, height: widthConstant))

        self.animateMoonAndSun(imageName: "sun.png")

        self.contentSunMoonView.contentMode = .scaleAspectFit
        self.contentSunMoonView.backgroundColor = .clear
        ...
        self.contentSunMoonView.layer.add(rotation, forKey: "rotationAnimation")
        
        self.contentView.addSubview(self.contentSunMoonView)
    }
    ...
    private func configureView() {
        ...
        borderTopView.backgroundColor = UIColor.white.withAlphaComponent(0.6) 
        ...
        hourTableView = UITableView(frame: CGRect(x: contentView.frame.width / 2 - 60 + extraSpace,
                                                  ...
                                                  width: self.isTimeRangeEnabled ? 100 : 60 ,
        ...
        if !isTimeRangeEnabled {  contentView.addSubview(colonLabel1) }
        ...
        if !isTimeRangeEnabled { contentView.addSubview(colonLabel2) }
...
extension DateTimePicker: UITableViewDataSource, UITableViewDelegate {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.layer.shadowColor = UIColor.darkGray.cgColor
    ...
    func animateMoonAndSun(imageName:String) {

        UIView.animate(withDuration: 1, delay: 0, options: [],
                       animations: {
                        self.contentBgView.alpha += 1
                        self.contentSunMoonView.frame.origin.x -= 10
                        self.contentSunMoonView.frame.origin.y -=  10
        },
                       completion: { (_) in
                        
                        self.contentSunMoonView.image = UIImage.init(named: imageName)
